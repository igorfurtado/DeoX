        ...
        <div className="section-module parallax-section7 bg-seventh-section">
            <div className="grid-seventh-section">
                ...
                <div className="mockup-description">
                    ...
                    <AnchorLink href='#form-contact' style={{ textDecoration: "none" }}><button className="btn-medium title-h5 text-blue" style={{ marginLeft: "90px", marginTop: "30px" }}>comece agora</button></AnchorLink>
                </div>
